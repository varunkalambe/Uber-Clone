  ...
  return (
    <div>
      <h5 className='p-1 text-center w-[93%] absolute top-0' onClick={()=>{
        ...
        }} className='flex border-2 active:border-gray-400 mb-2 rounded-xl w-full p-3 items-center justify-between '>
        ...
        <div onClick={()=> {
          ...
          <div className='-ml-6 w-1/2'>
            ...
            <p className='font-light text-xs text-gray-600'>Affordable, motarcycle rides</p>
          </div>
